...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PerfTool = __webpack_require__(1);
	
	var _PerfTool2 = _interopRequireDefault(_PerfTool);
	...
	// Import them styles
	exports.default = _PerfTool2.default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TimeWasted = __webpack_require__(179);
	
	var _TimeWasted2 = _interopRequireDefault(_TimeWasted);
	
	var _TabManager = __webpack_require__(180);
	...
	var PerfTool = function (_Component) {
	  _inherits(PerfTool, _Component);
	
	  function PerfTool(props) {
	    _classCallCheck(this, PerfTool);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PerfTool).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChartComponent = function (_Component) {
	  ...
	  function ChartComponent(props) {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ChartComponent).call(this, props));
	  }
	  ...
	  _createClass(ChartComponent, [{
	    ...
	    value: function renderChart(measurements) {
	      var data = measurements.map(function (measurement) {
	        return measurement['Wasted time (ms)'];
	      });
	      var labels = measurements.map(function (measurement) {
	        return measurement['Owner > component'];
	      });
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'chart-container', style: { maxWidth: '800px' } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart = __webpack_require__(36)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChartComponent = __webpack_require__(34);
	
	var _ChartComponent2 = _interopRequireDefault(_ChartComponent);
	
	var _excludedComponents = __webpack_require__(184);
	
	var _excludedComponents2 = _interopRequireDefault(_excludedComponents);
	
	var _formatTime = __webpack_require__(185);
	...
	var TimeWasted = function (_Component) {
	  ...
	  function TimeWasted(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TimeWasted).call(this, props));
	  ...
	  _createClass(TimeWasted, [{
	    key: 'startOrStopRecording',
	    value: function startOrStopRecording() {
	    ...
	    value: function printResults() {
	      var measurements = Perf.getWasted(Perf._allMeasurements).filter(function (measurement) {
	        var label = measurement['Owner > component'].split(' > ').pop();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TabHeader = __webpack_require__(181);
	...
	var TabManager = function (_Component) {
	  ...
	  function TabManager(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TabManager).call(this, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _titleize = __webpack_require__(205);
	...
	function TabHeader(props) {
	  return _react2.default.createElement(
	    'div',
	    { className: 'tab-header ' + (props.isActive ? 'active' : ''), onClick: props.onClick },
...
/***/ function(module, exports) {
	...
	exports.default = ['PerfTool', 'ChartComponent', 'FeatureList'];
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fecha = __webpack_require__(186);
	...
	function formatTime(time) {
	  return _fecha2.default.format(time, 'hh:mm:ss.SSS A');;
	};
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./left-hand.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./left-hand.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./right-hand.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./right-hand.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
